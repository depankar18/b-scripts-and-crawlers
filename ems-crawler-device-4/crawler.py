...
while(True) :
    ...
    try :
        print("EMS (Device 4) Crawler is up")
        ...
        # FETCHING THE EMS DATA (DEVICE 4) AND SAVING IT
        response=requests.get("http://iotbuilder.in/nit-dp/view.php?id=4")
        ...
        #requests.get("http://mail:7500/notify?message=Connected successfully to MongoDB "+date_today+" "+str(time_now)+" [UTC]. Database has been updated with EMS (Device 4) data.")
