...
while(True) :
    ...
    try :
        print("EMS (Device 1) Crawler is up")
        ...
        #requests.get("http://mail:7500/notify?message=Connected successfully to MongoDB "+date_today+" "+str(time_now)+" [UTC]. Database has been updated with EMS (Device 1) data.")
