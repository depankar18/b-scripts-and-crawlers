...
while(True) :
    ...
    try :
        print("EMS (Device 5) Crawler is up")
        ...
        # FETCHING THE EMS DATA (DEVICE 5) AND SAVING IT
        response=requests.get("http://iotbuilder.in/nit-dp/view.php?id=5")
        ...
        #requests.get("http://mail:7500/notify?message=Connected successfully to MongoDB "+date_today+" "+str(time_now)+" [UTC]. Database has been updated with EMS (Device 5) data.")
