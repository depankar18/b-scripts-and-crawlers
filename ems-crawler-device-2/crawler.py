...
while(True) :
    ...
    try :
        print("EMS (Device 2) Crawler is up")
        ...
        # FETCHING THE EMS DATA (DEVICE 2) AND SAVING IT
        response=requests.get("http://iotbuilder.in/nit-dp/view.php?id=2")
        ...
        #requests.get("http://mail:7500/notify?message=Connected successfully to MongoDB "+date_today+" "+str(time_now)+" [UTC]. Database has been updated with EMS (Device 2) data.")
